...
export class ClienteHttp<Enviar, Recibir> {
    ...
    public async get(): Promise<Recibir> {
        const respuesta: Recibir | null = await http.get(this._url).then(cargaÚtil => {
    ...
    public async post(cargaÚtil: Enviar): Promise<Recibir> {
        const respuesta: Recibir = await http.post(this._url, cargaÚtil).then(cargaÚtil => {
            return cargaÚtil.data as Recibir
        })
        if (!respuesta) {
    ...
    public async put(cargaÚtil: Enviar): Promise<Recibir> {
        const respuesta: Recibir = await http.put(this._url, cargaÚtil).then(cargaÚtil => {
            return cargaÚtil.data as Recibir
        })
        if (!respuesta) {
    ...
    public async delete(): Promise<Recibir> {
        const respuesta: Recibir = await http.delete(this._url).then(cargaÚtil => {
            return cargaÚtil.data as Recibir
        })
        if (!respuesta) {
